================================================================================
              MFC 라이브러리 : GunzItemTool 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 GunzItemTool 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 GunzItemTool 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
GunzItemTool.h
    ...
    특정 헤더가 포함되며 CGunzItemToolApp 응용 프로그램 클래스가 선언됩니다.

GunzItemTool.cpp
    CGunzItemToolApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\GunzItemTool.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 GunzItemTool.rc에 포함됩니다.

res\GunzItemTool.rc2
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 GunzItemTool.rc의
...
GunzItemToolDoc.h, GunzItemToolDoc.cpp - 문서
    CGunzItemToolDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CGunzItemToolDoc::Serialize 사용).
GunzItemToolView.h, GunzItemToolView.cpp - 문서 뷰
    CGunzItemToolView 클래스를 포함하는 파일입니다.
    CGunzItemToolView 개체를 사용하여 CGunzItemToolDoc 개체를 볼 수 있습니다.
res\GunzItemToolDoc.ico
    CGunzItemToolDoc 클래스의 MDI 자식 창의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 GunzItemTool.rc에 포함됩니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) GunzItemTool.pch 및 미리 컴파일된

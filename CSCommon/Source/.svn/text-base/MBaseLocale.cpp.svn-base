...
const MCountry GetCountryID( const char* pCountry )
{
	...
	if( 0 == stricmp("kor", pCountry) )
		return MC_KOREA;
	else if( 0 == stricmp("international", pCountry) )
		return MC_US;
	else if( 0 == stricmp("jpn", pCountry) )
		return MC_JAPAN;
	else if( 0 == stricmp("brz", pCountry) )
		return MC_BRAZIL;
	else if( 0 == stricmp("ind", pCountry) )
		return MC_INDIA;

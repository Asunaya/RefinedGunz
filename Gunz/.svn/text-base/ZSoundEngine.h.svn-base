...
protected:
	...
	bool CheckCulling(char* szName, SoundSource* pSS, rvector& vSoundPos, bool bHero, int* pnoutPriority=NULL);
...
public:
	...
	**/
	...
	int PlaySound(char* Name,rvector& pos,bool bHero=false, bool bLoop = false, DWORD dwDelay = 0 );
	void PlaySoundElseDefault(char* Name,char* NameDefault,rvector& pos,bool bHero=false, bool bLoop = false, DWORD dwDelay = 0 );

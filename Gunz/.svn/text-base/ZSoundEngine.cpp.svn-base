...
int ZSoundEngine::PlaySound(char* Name,rvector& pos,bool bHero, bool bLoop, DWORD dwDelay ) 
{
...
int ZSoundEngine::PlaySE(FSOUND_SAMPLE* pFS, rvector& pos, int Priority, bool bPlayer /* = false */, bool bLoop /* = false  */)
{
...
// 컬링 여부 결정
bool ZSoundEngine::CheckCulling(char* szName, SoundSource* pSS, rvector& vSoundPos, bool bHero, int* pnoutPriority)
{

...
void ChatCmd_Whisper(const char* line, const int argc, char **const argv)
{
	...
	// loop back
	char szMsg[512];
	sprintf(szMsg, "(To %s) : %s", szName, pszMsg);
...
// 
	...
	int mode = -1;
		 ...
		 if( stricmp(argv[1],"f1")==0 ) mode = 0;
	else if( stricmp(argv[1],"f2")==0 ) mode = 1;
	else if( stricmp(argv[1],"f3")==0 ) mode = 2;
	else if( stricmp(argv[1],"f4")==0 ) mode = 3;
	else if( stricmp(argv[1],"f5")==0 ) mode = 4;
	else if( stricmp(argv[1],"f6")==0 ) mode = 5;
	else if( stricmp(argv[1],"f7")==0 ) mode = 6;
	else if( stricmp(argv[1],"f8")==0 ) mode = 7;
	else 
		return;

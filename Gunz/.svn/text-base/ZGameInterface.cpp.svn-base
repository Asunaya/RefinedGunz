...
void ZGameInterface::OnDraw(MDrawContext *pDC)
{
	...
	if ( timeGetTime() >= m_dwTimeCount)
	{
		...
		char szText[ 256];
		if ( m_dwHourCount > 3)
			sprintf( szText, "%d 시간이 경과했습니다. 잠시 쉬었다 하시기 바랍니다.", m_dwHourCount);
		else
...
//		str += " ";
	...
	if(pItemDesc->m_nResLevel) {
		if(bAdd) str += " / ";
		sprintf(temp,"제한레벨:%d",pItemDesc->m_nResLevel);
...
MBitmap* ZGameInterface::GetQuestItemIcon( int nItemID, bool bSmallIcon)
{
	...
	{
		// Page
		case 200001 :	strcpy( szFileName, "slot_icon_page"); break;		// 찢겨진 13페이지
		case 200002 :	strcpy( szFileName, "slot_icon_page"); break;		// 찢겨진 25페이지
		case 200003 :	strcpy( szFileName, "slot_icon_page"); break;		// 찢겨진 41페이지
		case 200004 :	strcpy( szFileName, "slot_icon_page"); break;		// 찢겨진 65페이지

		// Skull
		case 200005 :	strcpy( szFileName, "slot_icon_skull"); break;		// 작은두골
		case 200006 :	strcpy( szFileName, "slot_icon_skull"); break;		// 큰두골
		case 200007 :	strcpy( szFileName, "slot_icon_skull"); break;		// 수수께기의 두골
		case 200008 :	strcpy( szFileName, "slot_icon_skull"); break;		// 고블린의 두골
		case 200009 :	strcpy( szFileName, "slot_icon_skull"); break;		// 고블린 킹의 두골
		case 200010 :	strcpy( szFileName, "slot_icon_skull"); break;		// 거대한 유골

		// Fresh
		case 200011 :	strcpy( szFileName, "slot_icon_fresh"); break;		// 날고기
		case 200012 :	strcpy( szFileName, "slot_icon_fresh"); break;		// 불고기
		case 200013 :	strcpy( szFileName, "slot_icon_fresh"); break;		// 스테이크

		// Ring
		case 200014 :	strcpy( szFileName, "slot_icon_ring"); break;		// 철귀걸이
		case 200015 :	strcpy( szFileName, "slot_icon_ring"); break;		// 은귀걸이
		case 200016 :	strcpy( szFileName, "slot_icon_ring"); break;		// 금귀걸이
		case 200017 :	strcpy( szFileName, "slot_icon_ring"); break;		// 플래티넘 귀걸이

		// Necklace
		case 200018 :	strcpy( szFileName, "slot_icon_neck"); break;		// 크림슨의 목걸이

		// Doll
		case 200019 :	strcpy( szFileName, "slot_icon_doll"); break;		// 스켈레톤 인형
		case 200020 :	strcpy( szFileName, "slot_icon_doll"); break;		// 코볼드 인형
		case 200021 :	strcpy( szFileName, "slot_icon_doll"); break;		// 고블린 인형
		case 200022 :	strcpy( szFileName, "slot_icon_doll"); break;		// 팜포우 인형
		case 200023 :	strcpy( szFileName, "slot_icon_doll"); break;		// 토끼인형
		case 200024 :	strcpy( szFileName, "slot_icon_doll"); break;		// 곰인형
		case 200025 :	strcpy( szFileName, "slot_icon_doll"); break;		// 저주 받은 곰인형
		case 200026 :	strcpy( szFileName, "slot_icon_doll"); break;		// 팜포우 아이돌
		case 200027 :	strcpy( szFileName, "slot_icon_doll"); break;		// 저주 받은 팜포우 아이돌

		// Book
		case 200028 :	strcpy( szFileName, "slot_icon_book"); break;		// 악마의 사전
		case 200029 :	strcpy( szFileName, "slot_icon_book"); break;		// 스크라이더의 명부 상편
		case 200030 :	strcpy( szFileName, "slot_icon_book"); break;		// 스크라이더의 명부 하편

		// Object
		case 200031 :	strcpy( szFileName, "slot_icon_object"); break;		// 축복받은 십자가
		case 200032 :	strcpy( szFileName, "slot_icon_object"); break;		// 저주받은 십자가
		case 200033 :	strcpy( szFileName, "slot_icon_object"); break;		// 곡괭이
		case 200034 :	strcpy( szFileName, "slot_icon_object"); break;		// 말하는 돌맹이
		case 200035 :	strcpy( szFileName, "slot_icon_object"); break;		// 얼음의 결정
		case 200036 :	strcpy( szFileName, "slot_icon_object"); break;		// 부서진 기어
		case 200037 :	strcpy( szFileName, "slot_icon_object"); break;		// 고급 기어

		// Sword
		case 200038 :	strcpy( szFileName, "slot_icon_qsword"); break;		// 고블린 킹의 도끼
	}

...
bool ZItemSlotView::OnEvent(MEvent* pEvent, MListener* pListener)
{
	...
	if ( pEvent->nMessage == MWM_LBUTTONDOWN)
	{
		...
		if (nItemID != 0)
		{
			...
			sprintf( szItemDescription1, "%s_ItemDescription1", m_szItemSlotPlace);
			sprintf( szItemDescription2, "%s_ItemDescription2", m_szItemSlotPlace);
			sprintf( szItemDescription3, "%s_ItemDescription3", m_szItemSlotPlace);
			sprintf( szItemIcon,         "%s_ItemIcon",         m_szItemSlotPlace);

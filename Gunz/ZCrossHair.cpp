...
void ZCrossHair::GetBitmaps(MBitmap** ppoutBitmap, MBitmap** ppoutPickBitmap, ZCrossHairPreset nPreset)
{
	...
	{
		sprintf_s(szBar[CH_CENTER],	"%s%02d%s",		FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_TOP],		"%s%02d%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_TOP,		FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_BOTTOM],	"%s%02d%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_BOTTOM,	FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_LEFT],		"%s%02d%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_LEFT,		FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_RIGHT],	"%s%02d%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_RIGHT,	FN_CROSSHAIR_TAILER);

		sprintf_s(szPick[CH_CENTER],	"%s%02d%s%s",		FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_TOP],		"%s%02d%s%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_TOP,		FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_BOTTOM],	"%s%02d%s%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_BOTTOM,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_LEFT],	"%s%02d%s%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_LEFT,		FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_RIGHT],	"%s%02d%s%s%s",	FN_CROSSHAIR_HEADER, (int)nPreset+1, FN_CROSSHAIR_RIGHT,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
	}
	else
	{
		sprintf_s(szBar[CH_CENTER],	"%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_TOP],		"%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_TOP,	FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_BOTTOM],	"%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_BOTTOM,FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_LEFT],		"%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_LEFT,	FN_CROSSHAIR_TAILER);
		sprintf_s(szBar[CH_RIGHT],	"%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_RIGHT, FN_CROSSHAIR_TAILER);

		sprintf_s(szPick[CH_CENTER],	"%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_TOP],		"%s%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_TOP,		FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_BOTTOM],	"%s%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_BOTTOM,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_LEFT],	"%s%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_LEFT,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
		sprintf_s(szPick[CH_RIGHT],	"%s%s%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, FN_CROSSHAIR_RIGHT,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
	}
